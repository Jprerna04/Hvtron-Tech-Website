...
import a1 from '../a6.png';
import a2 from '../a7.png';
    ...
    return (
        <div className="relative min-h-screen w-full">
            ...
            <div className="relative z-20">
                <aside className="relative overflow-hidden text-gray-200 rounded-lg sm:mx-16 mx-2 sm:py-16">
                    <div className="relative z-10 max-w-screen-xl px-4 pb-20 pt-10 sm:py-24 mx-auto sm:px-6 lg:px-8">
                        <div className="max-w-xl sm:mt-1 mt-80 space-y-8 text-center sm:text-right sm:ml-auto">
                            ...
                            Providing innovative electrical{' '}
                                <span className="hidden sm:block text-gray-100 text-2xl">
                                equipment and solutions 
                                </span>
                                <span className="hidden sm:block text-gray-100 text-xl">
                                since 2021
                                </span>
                            </h2>
                ...
                <h1 className="text-center text-white text-2xl sm:text-4xl py-10 font-medium">
                Cutting-Edge Electrical Equipment & Solutions
                </h1>
            </div>
        </div>
    );
